...
namespace RCPA.Proteomics.Mascot
{
  ...
  public class TestMascotResultHtmlStandaloneParser
  {
    ...
    {
      var testFile = new FileInfo(@TestContext.CurrentContext.TestDirectory + "/../../../data//mascot_result_protein_newversion.html");
    ...
    public void testO18Result()
    {
      MascotResult mr = new MascotResultHtmlStandaloneParser(true)
        .ParseFile(new FileInfo(@TestContext.CurrentContext.TestDirectory + "/../../../data//mascot_result_protein_o18.html"));
      Assert.AreEqual(1, mr.Count);
    ...
    {
      MascotResult mr = new MascotResultHtmlStandaloneParser(true)
        .ParseFile(new FileInfo(@TestContext.CurrentContext.TestDirectory + "/../../../data//mascot_result_protein_newversion.html"));
    ...
    {
      MascotResult mr = new MascotResultHtmlStandaloneParser(true)
        .ParseFile(new FileInfo(@TestContext.CurrentContext.TestDirectory + "/../../../data//mascot_result_Caseins00001.htm"));
